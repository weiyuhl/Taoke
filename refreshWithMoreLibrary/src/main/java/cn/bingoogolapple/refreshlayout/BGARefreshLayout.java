...
public class BGARefreshLayout extends LinearLayout {
    ...
    private void hiddenRefreshHeaderView() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                int paddingTop = (int) animation.getAnimatedValue();
                mWholeHeaderView.setPadding(0, paddingTop, 0, 0);
                if (mRefreshAnimatorListener != null) {
                    mRefreshAnimatorListener.offsetTopPadding(paddingTop);
    ...
    private HiddenRefreshAnimatorListener mRefreshAnimatorListener;

    public void setRefreshAnimatorListener(HiddenRefreshAnimatorListener mRefreshAnimatorListener) {
        this.mRefreshAnimatorListener = mRefreshAnimatorListener;
    }

    public interface HiddenRefreshAnimatorListener{
        void offsetTopPadding(int offset);
    }
